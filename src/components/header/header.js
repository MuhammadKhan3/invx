...
const Header = () => {
 ...
 <div className="navbar bg-base-100">
    {/*  */}
    <div className='text-gray-700 grid grid-cols-3 border-yellow-300 divide-x ml-[300px] '>
 ...
 <div className="navbar bg-primary text-white">
  ...
  {/* avatar */}
  <div className="dropdown dropdown-end text-gray-600 ml-[200px]">
