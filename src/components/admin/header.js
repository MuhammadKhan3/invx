...
<div>
  {/* side menu */}
{sidemenu &&  <div className={`z-50 w-[200px] inline-block  shadow-md bg-primary px-1  absolute float-left ${page==='productdetail' ? 'h-[970px]':'h-full'}`}>
  ...
  <ul className="relative text-white mt-5">
    ...
    <li className="relative btn btn-ghost w-[190px]">
      ...
      <Link to='/admin/purchase-request'>
