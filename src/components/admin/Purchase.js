                        ...
                        <table className="table table-zebra w-full">
                            ...
                            <tbody>
                                ...
                                <tr className='text-blue-500 font-medium text-[14px] cursor-pointer'>
                                    ...
                                    <td>
                                        <div className="avatar inline w-[30px] float-left  ">
                                            <div className="w-9 rounded-full ">
                                                <img src="https://placeimg.com/192/192/people" />
                                            </div>
                                        </div>
                                        <span className='ml-[50px] inline mt-[30px] text-[16px] top-[10px] relative  hover:underline active:text-blue-600'>Cy Ganderton</span>
                                    </td>
                                    <td className='relative  hover:underline active:text-blue-600'>Quality Control Specialist</td>
                                    <td className='relative  hover:underline active:text-blue-600'>24-10-2022</td>
